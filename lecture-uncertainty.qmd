...
- Because the calculations for decomposition involve division, when the crude rates for your comparisons are close together - and with the extra 'noise' from the bootstrapping, potentially overlap - the distribution of the decomposition can go haywire
- Ben navigate to https://benmatthewsed.github.io/sgsss_std_decomp/ratio_distribution.html 
