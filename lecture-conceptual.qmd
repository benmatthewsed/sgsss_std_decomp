...
format:
  revealjs:
    output-file: "lecture-conceptual.html"
...
[^1]: This is an important term! We will come back to this in a second
...
- Vote at [this menti link](https://www.menti.com/alj2qykb376m)
...
- In Kitagawa's [-@kitagawaComponentsDifferenceTwo1955] example, how much of the difference in mortality rates between areas is due to differences in their age, sex and race [sic] composition, and how much is 'left over'
...
- We can think of these as 'direct' and 'compositional' effects respectively [@vaupelDecomposingDemographicChange2002]
...
- Take a minute then vote on the options at [the menti](https://www.menti.com/al47qfxs37jv)
...
## A caveat
- @lundbergWhatYourEstimand2021 are actually quite critical of standardization and decomposition
...
- @lundbergWhatYourEstimand2021 are right about causality - you don't get causal effects out of standardization and decomposition (indeed @dasguptaStandardizationDecompositionRates1993 says as much)
