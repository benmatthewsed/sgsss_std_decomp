...
-   We illustrate this approach using the standardization and decomposition methods described by [@dasguptaStandardizationDecompositionRates1993] and implemented in the `{dasguptr}` R package [@kingDasGuptRGuptaStandardisation2025] to Scottish reconvictions data from 1997-2022
